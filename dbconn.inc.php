...
function dbConnect(){
	...
	$user = "gkb8719_dbuser"; // put your own user name here.
	$pwd = "testpasswordyay"; // put your own database password here
	$database = "gkb8719_4321"; // put your database name here
